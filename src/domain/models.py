...
class FewShotExample(BaseModel):
    ...
    user_input: str = Field(
        ...
        min_length=1,
        max_length=500,
        description="Texto de exemplo fornecido pelo usuário"
    )
    intent: IntentType = Field(
        ...,
        description="Intenção classificada para este exemplo"
    )
    ...
    metadata: dict[str, Any] = Field(
        ...
        description="Metadados adicionais do exemplo"
    )
...
class ClassificationResult(BaseModel):
    ...
    confidence_level: ConfidenceLevel = Field(
        ...,
        description="Categoria do nível de confiança"
    )
    ...
    model_used: str = Field(
        ...,
        description="Nome do modelo LLM utilizado"
    )
    ...
    metadata: dict[str, Any] = Field(
        default_factory=dict,
        description="Metadados adicionais da classificação"
    )
...
class LLMRequest(BaseModel):
    ...
    prompt: str = Field(
        ...,
        min_length=1,
        description="Prompt a ser enviado ao LLM"
    )
...
class LLMResponse(BaseModel):
    ...
    text: str = Field(
        ...,
        description="Texto gerado pelo LLM"
    )
    model: str = Field(
        ...,
...
class HealthStatus(BaseModel):
    ...
    status: str = Field(
        ...,
        description="Status geral (healthy, degraded, unhealthy)"
    )
    timestamp: datetime = Field(
        default_factory=datetime.utcnow,
    ...
    details: dict[str, Any] = Field(
        default_factory=dict,
        description="Detalhes adicionais do health check"
    )
